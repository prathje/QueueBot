...
export class RatingService {
   ...
   */
  async getLeaderboard(limit: number = 50): Promise<Array<{ player: string, rating: RatingValue, ordinal: number, ordinalDiff: number, matches: number }>> {
   ...
   */
  private calculateRatingChanges(matchResult: IMatchResult, playerRatings: Map<string, RatingValue>): Map<string, RatingValue> {
